...
public class HttpNotifierConfigTest {
    ...
    public void testGetCredentialsNotEmpty() throws FormException {
        ...
        StandardUsernamePasswordCredentials credentials = new UsernamePasswordCredentialsImpl(
                CredentialsScope.GLOBAL, httpCredentialsId, "description", httpUsername, httpPassword);
        buildStatusConfigStatic
                .when(() -> BuildStatusConfig.getCredentials(UsernamePasswordCredentials.class, httpCredentialsId))
    ...
    public void testGetCredentialsEmpty() {
        HttpNotifierConfig instance = HttpNotifierConfig.fromGlobalConfig("", "", "");
        buildStatusConfigStatic
                .when(() -> BuildStatusConfig.getCredentials(UsernamePasswordCredentials.class, "not-exist-credential"))
                .thenReturn(null);
