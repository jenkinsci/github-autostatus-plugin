...
public class InfluxDbNotifierSchemasTest {
    ...
    public void testV1Tests() {
        assertEquals(
                "tests,jobname=mockjobname,owner=mockowner,repo=mockrepo,branch=mockbranch passed=1,skipped=2,failed=3",
                v1Schema.formatTests(
                        "mockjobname", "mockowner", "mockrepo", "mockbranch", 1, 2, 3, "buildurl", 5, "cause"));
    }

    @Test
    public void testV2Tests() {
        assertEquals(
                "tests,owner=mockowner,repo=mockrepo jobname=\"mockjobname\",branch=\"mockbranch\",passed=1,skipped=2,failed=3,buildurl=\"buildurl\",buildnumber=4,trigger=\"cause\"",
                v2Schema.formatTests(
                        "mockjobname", "mockowner", "mockrepo", "mockbranch", 1, 2, 3, "buildurl", 4, "cause"));
    }

    @Test
    public void testV1TestSuite() {
        assertEquals(
                "testsuite,jobname=mockjobname,owner=mockowner,repo=mockrepo,branch=mockbranch,suite=mocksuite duration=1.0000,passed=2,skipped=3,failed=4",
                v1Schema.formatTestSuite(
                        "mockjobname",
                        "mockowner",
                        "mockrepo",
                        "mockbranch",
    ...
    public void testV2TestSuite() {
        assertEquals(
                "testsuite,owner=mockowner,repo=mockrepo,suitename=mocksuite jobname=\"mockjobname\",branch=\"mockbranch\",suite=\"mocksuite\",duration=1.0000,passed=2,skipped=3,failed=4,buildurl=\"buildurl\",buildnumber=5,trigger=\"cause\"",
                v2Schema.formatTestSuite(
                        "mockjobname",
                        "mockowner",
                        "mockrepo",
                        "mockbranch",
    ...
    public void testV1TestCase() {
        assertEquals(
                "testcase,jobname=mockjobname,owner=mockowner,repo=mockrepo,branch=mockbranch,suite=mocksuite,testcase=mocktestcase passed=1,skipped=2,failed=3",
                v1Schema.formatTestCase(
                        "mockjobname",
                        "mockowner",
                        "mockrepo",
                        "mockbranch",
    ...
    public void testV2TestCase() {
        assertEquals(
                "testcase,owner=mockowner,repo=mockrepo,suitename=mocksuite jobname=\"mockjobname\",branch=\"mockbranch\",suite=\"mocksuite\",testcase=\"mocktestcase\",passed=1,skipped=2,failed=3,buildurl=\"buildurl\",buildnumber=4,trigger=\"cause\"",
                v2Schema.formatTestCase(
                        "mockjobname",
                        "mockowner",
                        "mockrepo",
                        "mockbranch",
