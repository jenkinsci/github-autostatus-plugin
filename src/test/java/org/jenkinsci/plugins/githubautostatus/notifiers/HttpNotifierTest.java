...
public class HttpNotifierTest {
    ...
    public void testNotifyFinalBuildStatusWithTestResults() throws IOException {
        TestResults testResults = notifier.gson.fromJson(
                "{\"passed\":2,\"skipped\":0,\"failed\":0,\"suites\":[{\"name\":\"com.devops.test.DevOpsJavaSampleApplicationTests\",\"testCases\":[{\"name\":\"com.devops.test.DevOpsJavaSampleApplicationTests.testGreeting\",\"failed\":false,\"passed\":true,\"skipped\":false,\"result\":\"Passed\"},{\"name\":\"com.devops.test.DevOpsJavaSampleApplicationTests.contextLoads\",\"failed\":false,\"passed\":true,\"skipped\":false,\"result\":\"Passed\"}],\"passed\":2,\"skipped\":0,\"failed\":0}]}",
                TestResults.class);
    ...
    public void testNotifyFinalBuildStatusWithCoverage() throws IOException {
        CodeCoverage coverage = notifier.gson.fromJson(
                "{\"conditionals\":100.0,\"classes\":100.0,\"files\":-1.0,\"lines\":50.0,\"methods\":0.0,\"packages\":-1.0,\"instructions\":50.0}",
                CodeCoverage.class);
        Map<String, Object> parameter = createParameter();
